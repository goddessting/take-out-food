...
const best = require('../src/best-charge');
const allItems = require('../src/items.js');
...
describe('Take out food', function () {
  ...
  it('it should calculate count and subtotal', () => {
    ...
    let allItem = allItems.loadAllItems();

    const expectResult = best.buildCartItems(tags, allItem);
    const result = [{
      id: 'ITEM0001',
      name: '黄焖鸡',
      count: 1,
  ...
  it('it should calculate total', () => {
    ...
    const expectResult = best.buildReceiptItems(cartItems);
    const result = {
      cartItem: [{
        id: 'ITEM0001',
        name: '黄焖鸡',
  ...
  describe('buildReceipt', () => {
    ...
    it('满30且存在指定商品半价,指定商品更优惠', () => {
      ...
      const expectResult = best.buildReceipt(receiptItem, promotion);
      const result = {
        cartItem: [{
          id: 'ITEM0001',
          name: '黄焖鸡',
  ...
  describe('buildReceiptText', () => {
    it('未满30且没有指定菜品半价', () => {
      ...
      const expectResult = best.buildReceiptText(receipt);
      const result = `============= 订餐明细 =============
冰锋 x 10 = 20元
-----------------------------------
总计：20元
...
===================================`;
  ...
  describe('bestCharge', () => {
    it('should generate best charge when best is 指定菜品半价', function () {
      ...
      var summary = best.bestCharge(inputs);
      var expected = `============= 订餐明细 =============
黄焖鸡 x 1 = 18元
肉夹馍 x 2 = 12元
凉皮 x 1 = 8元
...
===================================`;
    ...
    it('should generate best charge when best is 满30减6元', function () {
      ...
      let summary = best.bestCharge(inputs);
      let expected = `============= 订餐明细 =============
肉夹馍 x 4 = 24元
凉皮 x 1 = 8元
-----------------------------------
